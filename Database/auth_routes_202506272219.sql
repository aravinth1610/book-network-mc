INSERT INTO auth_routes (api_end_point,can_activate,can_deactivate,component,`path`,path_match,permission,redirect_to,fk_parent_auth_route,created_by,created_on,delete_flag,updated_by,updated_on) VALUES
	 ...
	 ('/details/**','authGuard',NULL,'BookInvComp','BookInv',NULL,'GET,POST',NULL,NULL,'anonymousUser',SYSDATE(),0,NULL,NULL);
